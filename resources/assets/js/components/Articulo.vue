                            ...
                            <tbody>
                                <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                                    <td>
                                        ...
                                        <button type="button" @click="abrirModal('articulo','duplicar',articulo)" class="btn btn-warning btn-sm">
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==3" class="btn btn-primary" @click="registrarArticulo()">Duplicar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
        ...
        methods : {
           ...
           desactivarArticulo(id){
            ...
            validarArticulo(){
                ...
                if (this.idcategoria==0) this.errorMostrarMsjArticulo.push("Debe eligir una categoria.");
                if (!this.nombre) this.errorMostrarMsjArticulo.push("El nombre del articulo no puede estar vacío.");
                if (!this.stock) this.errorMostrarMsjArticulo.push("Elija una cantidad para el stok.");
                if (!this.precio_venta) this.errorMostrarMsjArticulo.push("Elija un valor al servicio.");
